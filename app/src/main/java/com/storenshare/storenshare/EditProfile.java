...
public class EditProfile extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            startActivity(new Intent(EditProfile.this,CreateDocsActivity.class));
        } else if (id == R.id.nav_slideshow) {
            startActivity(new Intent(EditProfile.this,SharedWithMeActivity.class));
            ...
            mGoogleSignInClient.signOut()
                    .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            Toast.makeText(EditProfile.this, "Signout Success", Toast.LENGTH_LONG).show();
